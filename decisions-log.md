...
**Date:** 2026-03-24
**Decision:** Used Mongoose over raw MongoDB driver for all schema work
**Reason:** Validation and middleware hooks reduce boilerplate across routes
**Alternatives considered:** Raw driver (too verbose for small projects), Prisma (overkill without TypeScript)
